...
public class Activity5 {
    ...
    public void smsTest() {
        ...
        // Find the element to add recipient and // Press ENTER
        driver.findElement(AppiumBy.id("com.google.android.apps.messaging:id/recipient_text_view")).sendKeys("9448425041");

        //Below line ENTER is not working.
        ...
        // Assertion
        String messageTextSent = driver.findElement(AppiumBy.id("com.google.android.apps.messaging:id/sim_picker_fragment")).getText();
